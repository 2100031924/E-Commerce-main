      ...
      <div className="max-w-4xl w-full grid md:grid-cols-2 bg-[#0d1117] rounded-2xl overflow-hidden shadow-2xl border border-white/5">
        ...
        <div className="p-12 flex flex-col justify-between bg-gradient-to-b from-[#1a1f2e] to-[#0d1117]">
          <div>
            ...
            <h2 className="text-4xl font-bold bg-gradient-to-r from-[#FF8C00] to-[#FFA500] bg-clip-text text-transparent mb-4">Welcome Back!</h2>
            <p className="text-gray-400 mb-8">Access your orders, wishlist, and personalized recommendations</p>
            
            <ul className="space-y-4 mb-12">
              <li className="flex items-center gap-3 text-white/90">
                <span className="text-[#FF8C00]">🚀</span> Fast checkout & easy returns
              </li>
              <li className="flex items-center gap-3 text-white/90">
                <span className="text-[#FF8C00]">🎁</span> Exclusive member-only deals
              </li>
              <li className="flex items-center gap-3 text-white/90">
                <span className="text-[#FF8C00]">📦</span> Track orders in real-time
              </li>
            </ul>
          </div>
        ...
        <div className="p-12 border-l-4 border-[#FF8C00] bg-[#0d1117]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="accent-[#FF8C00]" />
                Remember me
              </label>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500 mb-8">By signing in, you agree to our Terms of Service and Privacy Policy</p>
            <p className="text-gray-400 mb-4">New to E-Commerce Shop?</p>
            <Link to="/register" className="inline-block w-full border border-white/20 text-white py-3 rounded-lg font-bold hover:bg-white/5 transition-all">
              CREATE NEW ACCOUNT
            </Link>
          </div>
        </div>
